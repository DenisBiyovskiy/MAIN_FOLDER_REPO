define("ilayTariffPlanSelectionModule", ["ilayTariffPlanSelectionModuleResources", "ilayTariffPlanSelectionView",
	"ilayTariffPlanSelectionViewModel", "MaskHelper", "BaseSchemaModuleV2"],
	function(resources, moduleView, moduleViewModel, MaskHelper) {
		 ...
		 */
		Ext.define("Terrasoft.configuration.ilayTariffPlanSelectionModule", {
			alternateClassName: "Terrasoft.ilayTariffPlanSelectionModule",
			...
			loadModules: function() {
				...
				var scope = this;
				setTimeout(scope.viewModel.loadQuickSearchModuleForPackage, 10000, "searchContainer1");//Den
			},
		...
		return Terrasoft.ilayTariffPlanSelectionModule;
	});
