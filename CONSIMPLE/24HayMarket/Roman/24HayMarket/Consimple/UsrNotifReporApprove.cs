...
string newTitle = "Reporting document approved at " + "<a href=\"https://24haymarket-test.bpmonline.com/0/Nui/ViewModule.aspx#CardModuleV2/AccountPageV2/edit/" + Get<Guid>("AccountID") + "\">" + Get<string>("AccountName") + "</a>";
