...
namespace FacebookGraphAPIHelper.Objects
{
    ...
    public class FBGraphAPIExceptionWrapper
    {
    ...
    public class Reactions : Paging
    {
        public List<Reaction> data;
    }
    ...
    public class SharedPosts : Paging
    {
        public List<SharedPost> data;
    }
